...
<body>
    <div class="w">
        ...
        <header class="header">
            ...
            <h1 style="line-height: 140px;text-align: center;">欢迎来到注册页面！</h1>
        </header>
        <!-- 头部header的制作 end-->
        ...
        <div class="registerarea">
            ...
            <div class="registerarea_hd">
                <h2>注册新用户</h2>
                <h2 style="color: #c81623;position: absolute;margin-left: 480px;">
                    ${requestScope.info}
<%--                    ${empty requestScope.info ? "":requestScope.info}--%>
<%--                    <%=request.getAttribute("info") == null?"":request.getAttribute("info")%>--%>
            ...
            <div class="reg_form">
                <form action="registServlet" method="get">
                    <ul>
                        <!-- 错误的制作 -->
                        <li><label for="">用户名：</label><input type="text" name="name">
                        </li>
                        ...
                        <!-- 提交的制作 -->
                        <li class="submit"><input type="submit" value="完成注册" class="but"></li>
                    </ul>
                </form>
            </div>
        </div>
