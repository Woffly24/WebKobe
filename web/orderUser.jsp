...
<body>
    <div class="w">
        ...
        <header class="header">
            ...
            <h1 style="line-height: 140px;text-align: center;">您已进入自己的订单管理页面！</h1>
        </header>
        <!-- 头部header的制作 end-->
        ...
        <div class="registerarea" style="height: 800px;overflow: scroll;">
            ...
            <div class="registerarea_hd">
                <h2 style="color: #c81623;position: absolute;margin-left: 465px;">您可以在此页面查看自己的订单</h2>
            </div>
            <!-- 主体的制作 -->
            <div class="reg_form">
                <table>
                    <tr>
                        ...
                        <c:forEach items="${sessionScope.results}" var="result">
                            <tr>
                                ...
                                <td>
                                    <c:if test="${result.status == 0}">已发货</c:if>
<%--                                    <c:if test="${result.status == 1}">已发货</c:if>--%>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><a href="orderServlet?action=receiverOrder"><button style="width: 100px;height: 30px;font-size: 16px;background-color: #b1191a">是</button></a></td>
                    </tr>
                </table>
            </div>
        </div>
